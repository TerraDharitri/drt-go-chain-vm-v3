...
type VMHost interface {
	...
	ExecuteDCDTTransfer(destination []byte, sender []byte, dcdtTransfers []*vmcommon.DCDTTransfer, callType vm.CallType) (*vmcommon.VMOutput, uint64, error)
...
type OutputContext interface {
	...
	TransferDCDT(destination []byte, sender []byte, transfers []*vmcommon.DCDTTransfer, callInput *vmcommon.ContractCallInput) (uint64, error)
