...
// extern int32_t	v1_4_transferDCDTExecute(void *context, int32_t dstOffset, int32_t tokenIDOffset, int32_t tokenIdLen, int32_t valueOffset, long long gasLimit, int32_t functionOffset, int32_t functionLength, int32_t numArguments, int32_t argumentsLengthOffset, int32_t dataOffset);
// extern int32_t	v1_4_transferDCDTNFTExecute(void *context, int32_t dstOffset, int32_t tokenIDOffset, int32_t tokenIdLen, int32_t valueOffset, long long nonce, long long gasLimit, int32_t functionOffset, int32_t functionLength, int32_t numArguments, int32_t argumentsLengthOffset, int32_t dataOffset);
// extern int32_t	v1_4_multiTransferDCDTNFTExecute(void *context, int32_t dstOffset, int32_t numTokenTransfers, int32_t tokenTransfersArgsLengthOffset, int32_t tokenTransferDataOffset, long long gasLimit, int32_t functionOffset, int32_t functionLength, int32_t numArguments, int32_t argumentsLengthOffset, int32_t dataOffset);
...
// extern int32_t	v1_4_getDCDTValue(void *context, int32_t resultOffset);
// extern int32_t	v1_4_getDCDTTokenName(void *context, int32_t resultOffset);
// extern long long	v1_4_getDCDTTokenNonce(void *context);
// extern int32_t	v1_4_getDCDTTokenType(void *context);
// extern int32_t	v1_4_getCallValueTokenName(void *context, int32_t callValueOffset, int32_t tokenNameOffset);
// extern int32_t	v1_4_getDCDTValueByIndex(void *context, int32_t resultOffset, int32_t index);
// extern int32_t	v1_4_getDCDTTokenNameByIndex(void *context, int32_t resultOffset, int32_t index);
// extern long long	v1_4_getDCDTTokenNonceByIndex(void *context, int32_t index);
// extern int32_t	v1_4_getDCDTTokenTypeByIndex(void *context, int32_t index);
...
// extern int32_t	v1_4_getNumDCDTTransfers(void *context);
// extern long long v1_4_getCurrentDCDTNFTNonce(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen);
...
// extern int32_t	v1_4_getDCDTBalance(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce, int32_t resultOffset);
// extern int32_t	v1_4_getDCDTNFTNameLength(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce);
// extern int32_t	v1_4_getDCDTNFTAttributeLength(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce);
// extern int32_t	v1_4_getDCDTNFTURILength(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce);
// extern int32_t	v1_4_getDCDTTokenData(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce, int32_t valueOffset, int32_t propertiesOffset, int32_t hashOffset, int32_t nameOffset, int32_t attributesOffset, int32_t creatorOffset, int32_t royaltiesOffset, int32_t urisOffset);
// extern long long	v1_4_getDCDTLocalRoles(void *context, int32_t tokenIdHandle);
...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-vm-v3/math"
...
func failIfMoreThanOneDCDTTransfer(context unsafe.Pointer) bool {
	runtime := vmhost.GetRuntimeContext(context)
	if len(runtime.GetVMInput().DCDTTransfers) > 1 {
		return vmhost.WithFault(vmhost.ErrTooManyDCDTTransfers, context, true)
	}
	return false
}
...
func BaseOpsAPIImports(imports vmhooksmeta.EIFunctionReceiver) error {
	...
	err = imports.Append("transferDCDTExecute", v1_4_transferDCDTExecute, C.v1_4_transferDCDTExecute)
	if err != nil {
		return err
	}

	err = imports.Append("transferDCDTNFTExecute", v1_4_transferDCDTNFTExecute, C.v1_4_transferDCDTNFTExecute)
	if err != nil {
		return err
	}

	err = imports.Append("multiTransferDCDTNFTExecute", v1_4_multiTransferDCDTNFTExecute, C.v1_4_multiTransferDCDTNFTExecute)
	if err != nil {
		return err
	}
	...
	err = imports.Append("getDCDTValue", v1_4_getDCDTValue, C.v1_4_getDCDTValue)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenName", v1_4_getDCDTTokenName, C.v1_4_getDCDTTokenName)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenType", v1_4_getDCDTTokenType, C.v1_4_getDCDTTokenType)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenNonce", v1_4_getDCDTTokenNonce, C.v1_4_getDCDTTokenNonce)
	if err != nil {
		return err
	}
	...
	err = imports.Append("getDCDTValueByIndex", v1_4_getDCDTValueByIndex, C.v1_4_getDCDTValueByIndex)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenNameByIndex", v1_4_getDCDTTokenNameByIndex, C.v1_4_getDCDTTokenNameByIndex)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenTypeByIndex", v1_4_getDCDTTokenTypeByIndex, C.v1_4_getDCDTTokenTypeByIndex)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenNonceByIndex", v1_4_getDCDTTokenNonceByIndex, C.v1_4_getDCDTTokenNonceByIndex)
	if err != nil {
		return err
	}
	...
	err = imports.Append("getNumDCDTTransfers", v1_4_getNumDCDTTransfers, C.v1_4_getNumDCDTTransfers)
	if err != nil {
		return err
	}

	err = imports.Append("getCurrentDCDTNFTNonce", v1_4_getCurrentDCDTNFTNonce, C.v1_4_getCurrentDCDTNFTNonce)
	if err != nil {
		return err
	}
	...
	err = imports.Append("getDCDTBalance", v1_4_getDCDTBalance, C.v1_4_getDCDTBalance)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTTokenData", v1_4_getDCDTTokenData, C.v1_4_getDCDTTokenData)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTLocalRoles", v1_4_getDCDTLocalRoles, C.v1_4_getDCDTLocalRoles)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTNFTNameLength", v1_4_getDCDTNFTNameLength, C.v1_4_getDCDTNFTNameLength)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTNFTAttributeLength", v1_4_getDCDTNFTAttributeLength, C.v1_4_getDCDTNFTAttributeLength)
	if err != nil {
		return err
	}

	err = imports.Append("getDCDTNFTURILength", v1_4_getDCDTNFTURILength, C.v1_4_getDCDTNFTURILength)
	if err != nil {
		return err
	}
...
//export v1_4_getDCDTBalance
func v1_4_getDCDTBalance(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_4_getDCDTNFTNameLength
func v1_4_getDCDTNFTNameLength(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
	...
	if dcdtData == nil || dcdtData.TokenMetaData == nil {
		vmhost.WithFaultIfFailAlwaysActive(vmhost.ErrNilDCDTData, context, runtime.BaseOpsErrorShouldFailExecution())
		return 0
	}
...
//export v1_4_getDCDTNFTAttributeLength
func v1_4_getDCDTNFTAttributeLength(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_4_getDCDTNFTURILength
func v1_4_getDCDTNFTURILength(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_4_getDCDTTokenData
func v1_4_getDCDTTokenData(
	context unsafe.Pointer,
	addressOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_4_getDCDTLocalRoles
func v1_4_getDCDTLocalRoles(context unsafe.Pointer, tokenIdHandle int32) int64 {
	managedType := vmhost.GetManagedTypesContext(context)
	runtime := vmhost.GetRuntimeContext(context)
...
func v1_4_transferValue(context unsafe.Pointer, destOffset int32, valueOffset int32, dataOffset int32, length int32) int32 {
	...
	if isBuiltInCall(string(data), host) {
		vmhost.WithFaultIfFailAlwaysActive(vmhost.ErrTransferValueOnDCDTCall, context, runtime.BaseOpsErrorShouldFailExecution())
		return 1
	}
...
func TransferValueExecuteWithTypedArgs(
	...
	if contractCallInput != nil {
		if host.IsBuiltinFunctionName(contractCallInput.Function) {
			vmhost.WithFaultAndHostIfFailAlwaysActive(vmhost.ErrNilDCDTData, host, runtime.BaseOpsErrorShouldFailExecution())
			return 1
		}
	}
...
//export v1_4_transferDCDTExecute
func v1_4_transferDCDTExecute(
	context unsafe.Pointer,
	destOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
	...
	return v1_4_transferDCDTNFTExecute(context, destOffset, tokenIDOffset, tokenIDLen, valueOffset, 0,
		gasLimit, functionOffset, functionLength, numArguments, argumentsLengthOffset, dataOffset)
}

//export v1_4_transferDCDTNFTExecute
func v1_4_transferDCDTNFTExecute(
	context unsafe.Pointer,
	destOffset int32,
	tokenIDOffset int32,
	tokenIDLen int32,
...
//export v1_4_multiTransferDCDTNFTExecute
func v1_4_multiTransferDCDTNFTExecute(
	context unsafe.Pointer,
	destOffset int32,
...
func TransferDCDTNFTExecuteWithTypedArgs(
	...
	gasLimitForExec, executeErr := output.TransferDCDT(dest, sender, transfers, contractCallInput)
	if vmhost.WithFaultAndHost(host, executeErr, runtime.BaseOpsErrorShouldFailExecution()) {
		return 1
	}
...
func v1_4_checkNoPayment(context unsafe.Pointer) {
	...
	if vmInput.CallValue.Sign() > 0 {
		_ = vmhost.WithFault(vmhost.ErrNonPayableFunctionRewa, context, runtime.BaseOpsErrorShouldFailExecution())
		return
	}
	if len(vmInput.DCDTTransfers) > 0 {
		_ = vmhost.WithFault(vmhost.ErrNonPayableFunctionDcdt, context, runtime.BaseOpsErrorShouldFailExecution())
		return
	}
}
...
//export v1_4_getDCDTValue
func v1_4_getDCDTValue(context unsafe.Pointer, resultOffset int32) int32 {
	isFail := failIfMoreThanOneDCDTTransfer(context)
	if isFail {
		return -1
	}
	return v1_4_getDCDTValueByIndex(context, resultOffset, 0)
}

//export v1_4_getDCDTValueByIndex
func v1_4_getDCDTValueByIndex(context unsafe.Pointer, resultOffset int32, index int32) int32 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)

	gasToUse := metering.GasSchedule().BaseOpsAPICost.GetCallValue
	metering.UseGasAndAddTracedGas(getDCDTValueByIndexName, gasToUse)

	var value []byte

	dcdtTransfer := getDCDTTransferFromInputFailIfWrongIndex(vmhost.GetVMHost(context), index)
...
//export v1_4_getDCDTTokenName
func v1_4_getDCDTTokenName(context unsafe.Pointer, resultOffset int32) int32 {
	isFail := failIfMoreThanOneDCDTTransfer(context)
	if isFail {
		return -1
	}
	return v1_4_getDCDTTokenNameByIndex(context, resultOffset, 0)
}

//export v1_4_getDCDTTokenNameByIndex
func v1_4_getDCDTTokenNameByIndex(context unsafe.Pointer, resultOffset int32, index int32) int32 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)

	gasToUse := metering.GasSchedule().BaseOpsAPICost.GetCallValue
	metering.UseGasAndAddTracedGas(getDCDTTokenNameByIndexName, gasToUse)
...
//export v1_4_getDCDTTokenNonce
func v1_4_getDCDTTokenNonce(context unsafe.Pointer) int64 {
	isFail := failIfMoreThanOneDCDTTransfer(context)
	if isFail {
		return -1
	}
	return v1_4_getDCDTTokenNonceByIndex(context, 0)
}

//export v1_4_getDCDTTokenNonceByIndex
func v1_4_getDCDTTokenNonceByIndex(context unsafe.Pointer, index int32) int64 {
	metering := vmhost.GetMeteringContext(context)

	gasToUse := metering.GasSchedule().BaseOpsAPICost.GetCallValue
	metering.UseGasAndAddTracedGas(getDCDTTokenNonceByIndexName, gasToUse)
...
//export v1_4_getCurrentDCDTNFTNonce
func v1_4_getCurrentDCDTNFTNonce(context unsafe.Pointer, addressOffset int32, tokenIDOffset int32, tokenIDLen int32) int64 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
	storage := vmhost.GetStorageContext(context)

	gasToUse := metering.GasSchedule().BaseOpsAPICost.StorageLoad
	metering.UseGasAndAddTracedGas(getCurrentDCDTNFTNonceName, gasToUse)
...
//export v1_4_getDCDTTokenType
func v1_4_getDCDTTokenType(context unsafe.Pointer) int32 {
	isFail := failIfMoreThanOneDCDTTransfer(context)
	if isFail {
		return -1
	}
	return v1_4_getDCDTTokenTypeByIndex(context, 0)
}

//export v1_4_getDCDTTokenTypeByIndex
func v1_4_getDCDTTokenTypeByIndex(context unsafe.Pointer, index int32) int32 {
	metering := vmhost.GetMeteringContext(context)

	gasToUse := metering.GasSchedule().BaseOpsAPICost.GetCallValue
	metering.UseGasAndAddTracedGas(getDCDTTokenTypeByIndexName, gasToUse)
...
//export v1_4_getNumDCDTTransfers
func v1_4_getNumDCDTTransfers(context unsafe.Pointer) int32 {
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)

	gasToUse := metering.GasSchedule().BaseOpsAPICost.GetCallValue
	metering.UseGasAndAddTracedGas(getNumDCDTTransfersName, gasToUse)
...
func ExecuteOnDestContextByCallerWithTypedArgs(
	...
	if isBuiltInCall(contractCallInput.Function, host) {
		...
		if contractCallInput.Function != core.BuiltInFunctionDCDTNFTCreate {
			if vmhost.WithFaultAndHost(host, err, runtime.BaseOpsErrorShouldFailExecution()) {
				return -1
			}
			return -1
