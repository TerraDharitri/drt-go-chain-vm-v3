...
// extern void			v1_4_bigIntGetDCDTCallValue(void *context, int32_t destination);
// extern void			v1_4_bigIntGetDCDTCallValueByIndex(void *context, int32_t destination, int32_t index);
// extern void			v1_4_bigIntGetDCDTExternalBalance(void *context, int32_t addressOffset, int32_t tokenIDOffset, int32_t tokenIDLen, long long nonce, int32_t result);
...
func BigIntImports(imports vmhooksmeta.EIFunctionReceiver) error {
	...
	err = imports.Append("bigIntGetDCDTCallValue", v1_4_bigIntGetDCDTCallValue, C.v1_4_bigIntGetDCDTCallValue)
	if err != nil {
		return err
	}

	err = imports.Append("bigIntGetDCDTExternalBalance", v1_4_bigIntGetDCDTExternalBalance, C.v1_4_bigIntGetDCDTExternalBalance)
	if err != nil {
		return err
	}
	...
	err = imports.Append("bigIntGetDCDTCallValueByIndex", v1_4_bigIntGetDCDTCallValueByIndex, C.v1_4_bigIntGetDCDTCallValueByIndex)
	if err != nil {
		return err
	}
...
//export v1_4_bigIntGetDCDTCallValue
func v1_4_bigIntGetDCDTCallValue(context unsafe.Pointer, destination int32) {
	isFail := failIfMoreThanOneDCDTTransfer(context)
	if isFail {
		return
	}
	v1_4_bigIntGetDCDTCallValueByIndex(context, destination, 0)
}

//export v1_4_bigIntGetDCDTCallValueByIndex
func v1_4_bigIntGetDCDTCallValueByIndex(context unsafe.Pointer, destinationHandle int32, index int32) {
	managedType := vmhost.GetManagedTypesContext(context)
	metering := vmhost.GetMeteringContext(context)

	gasToUse := metering.GasSchedule().BigIntAPICost.BigIntGetCallValue
	metering.UseGasAndAddTracedGas(bigIntGetDCDTCallValueByIndexName, gasToUse)
...
//export v1_4_bigIntGetDCDTExternalBalance
func v1_4_bigIntGetDCDTExternalBalance(context unsafe.Pointer, addressOffset int32, tokenIDOffset int32, tokenIDLen int32, nonce int64, resultHandle int32) {
	managedType := vmhost.GetManagedTypesContext(context)
	runtime := vmhost.GetRuntimeContext(context)
	metering := vmhost.GetMeteringContext(context)
