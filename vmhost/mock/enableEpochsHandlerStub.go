...
type EnableEpochsHandlerStub struct {
	...
	MultiDCDTTransferAsyncCallBackEnableEpochField uint32
...
func (stub *EnableEpochsHandlerStub) GetActivationEpoch(flag core.EnableEpochFlag) uint32 {
	...
	switch flag {
	case vmhost.MultiDCDTTransferFixOnCallBackFlag:
		return stub.MultiDCDTTransferAsyncCallBackEnableEpochField
