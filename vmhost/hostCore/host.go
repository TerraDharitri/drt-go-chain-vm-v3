...
import (
	...
	"github.com/TerraDharitri/drt-go-chain-vm-v3/crypto/factory"
...
// allFlags must have all flags used by drt-go-chain-vm-v3 in the current version
...
func createActivationMap(hostParameters *vmhost.VMHostParameters) map[uint32]struct{} {
	...
	activationMap[hostParameters.EnableEpochsHandler.GetActivationEpoch(vmhost.MultiDCDTTransferFixOnCallBackFlag)] = struct{}{}
